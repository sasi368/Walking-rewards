    ...
    return (
      <Container style={styles.container}>
        ...
        <Content style={styles.content}>
         ...
         <Image style={styles.img_style} source={login_logo} />
      
          <View style={{marginTop:'40%'}} />
          <View style={{padding:'7%'}}>
          <Text style={styles.txt_style}>Login</Text>
          <Text style={styles.txt_style2}>Please sign in to continue</Text>
          </View>
         ...
         <View style={{ width: "80%", alignSelf: "center" }}>
          ...
          <View style={{ width: "80%", alignSelf: "center" }}>
              <Button block style={styles.request_button} onPress={this.login}>
                <Text style={styles.request_button_text}>LOGIN</Text>
              </Button>
            </View>
